            ...
            ScrollView {
                VStack(spacing: 24) {
                    ...
                    Button {
                        ...
                        // Show validation error if incomplete
                        if !viewModel.isProfileComplete {
                        ...
                        Task {
                            ...
                            // ContentView will automatically transition to MainTabView when profile is complete
                        }
                    } label: {
                        HStack {
                        ...
                        .frame(height: 50)
                        .background(viewModel.isProfileComplete && !viewModel.isLoading ? Color.blue : Color.gray.opacity(0.6))
